...
crosswalk_file = "zcta_tract_cross_walk_2010_census.csv"
crosswalk = pd.read_csv(crosswalk_file)

# Merge combined data with the crosswalk
state_county_tract_zcta_prices = combined_data.merge(crosswalk, on='tract_id', how='left')

# Save the final combined data with ZIP codes
state_county_tract_zcta_prices.to_csv(file_name, index=False)
