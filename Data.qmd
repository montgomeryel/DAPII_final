...
#LL- should we export vacant_df as a csv
# so that we don't have to run the process again? 
```

```{python}
census_data=pd.read_csv(r"C:\Users\laine\OneDrive\Documents\GitHub\DAPII_final\B2575_raw.csv")
```


```{python}
geo_data=gpd.read_file(r"C:\Users\laine\OneDrive\Documents\GitHub\DAPII_final\geo_export_babed850-df6f-42f1-a951-f174092d5ba8.shp")
